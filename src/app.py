...
activities = {
    ...
    "Basketball Club": {
        "description": "Improve shooting, defense, and game strategy in a fun team environment",
    ...
    "Art Workshop": {
        "description": "Create paintings, sketches, and mixed-media artwork with guided instruction",
